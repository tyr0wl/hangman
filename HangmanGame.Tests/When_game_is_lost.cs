...
{
    public class When_game_is_lost
    {
        ...
        public void SetUp()
        {
            ...
            _hangman.StartGame();
            _hangman.Attempt('e');
            _hangman.Lost += OnLoss;
            _hangman.StopGame();
        }

        private void OnLoss(object sender, HangmanEventArgs e)
        {
            _actualHangmanEventArgs = e;
        }

        [Test]
        public void Lost_Event_should_be_raised()
        {
